...
public class CalcRestClient {
    ...
    public static void main(String[] args) {
        ...
        WebResource addService = service.path(ADD_PATH).queryParam("a","122").queryParam("b","34");
        ...
        WebResource subService = service.path(SUB_PATH).queryParam("a","122").queryParam("b","34");
